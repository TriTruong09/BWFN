...
const categoriesWithIcon =  [
    { id: "racket", label: "Vợt cầu lông", icon: DumbbellIcon },
    { id: "shoes", label: "Giày", icon: FootprintsIcon },
    { id: "tshirt", label: "Áo cầu lông", icon: ShirtIcon},
    { id: "short", label: "Quần cầu lông", icon: GhostIcon},
    { id: "accessory", label: "Phụ kiện cầu lông", icon: BackpackIcon },
  ];
